...
void pointers()
{
    // find out address width
    printf("\nNumber of memory addressing bits:");
    system("getconf LONG_BIT");
    printf("\n");

    printf("[Signed]\n");
    printf("char pointer:   %lu bytes\n",sizeof(char*));
    printf("short pointer:  %lu bytes\n",sizeof(short*));
    printf("int pointer:    %lu bytes\n",sizeof(int*));
    printf("float pointer:  %lu bytes\n",sizeof(float*));
    printf("double pointer: %lu bytes\n",sizeof(double*));
...
void arrays()
{
    ...
    printf("Number of elements in array [entries] = %lu\n",sizeof(entries)/sizeof(entries[0]));
    printf("Number of characters in array [course_name] = %lu\n",sizeof(course_name)/sizeof(course_name[0]));
    int j = 0;
...
void structures()
{
    ...
    rec_1 r1,r2;
    printf("Size of structure r1 (after initialization) = %lu bytes\n",sizeof(r1));
    pause();
    ...
    name_list[0] = "PJN";
    name_list[1] = "Vineet";         
    const course_type ctypArr[] = {cse,csd};
